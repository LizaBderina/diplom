...
import "../styles/pages/renovation-house.css";
import { ConsultationForm } from "../components/common/ConsultationForm";
import CallbackModal from "../components/modals/CallbackModal";

// Массив видео для секции «Внимательны ко всем деталям»
const videos = [
    { id: "37674b6eb5f4497065ab45dc3f9c16c8", caption: "Рейки, которые можно менять" },
    { id: "33ee61716eeebd5261d1b25480d0efe4", caption: "Просто посмотрите на разницу в заделке" },
    { id: "31c287cd78a6bc7e05c6472198ed155a", caption: "Ловите лайфхаки с мрамором" },
    { id: "de79cfd1b62d85878a2ad1851e1b4008", caption: "Чудо-прибор" },
    { id: "54f3f77d9656be17b8ba93f6ac03274c", caption: "Ловите лайфхаки по батареям" },
    { id: "c589da1d37ca26f6100741edc469932a", caption: "Для чего нужна сетка? Рассказал тут" },
    { id: "39e946f78b9621c72c2d983fed366462", caption: "Ловите лайфхаки" },
    { id: "00e19df35c3a70ac7464151ebe18a6b3", caption: "Ловите ещё лайфхаки" },
  ];

  const RenovationHousePage = () => {
    const [isModalOpen, setIsModalOpen] = useState(false);
  
    // скролл вверх при монтировании
    useEffect(() => {
      window.scrollTo(0, 0);
    }, []);
    ...
    const closeModal = () => setIsModalOpen(false);
        return (
            <div className="renovation-house-page">
                <Header />
                    ...
                    <div className="container">
                        <div className="banner-content">
                            <h1 className="main-title">
                                Ремонт загородных домов под ключ
                            </h1>
                            <h2 className="sub-title">с гарантией 5 лет</h2>
                            <p className="banner-description">
                                Ремонт домов от&nbsp;300&nbsp;кв.м. Дизайн-проект в&nbsp;подарок
                            </p>
                ...
                <section className="our-approach-section">
                    <div className="container">
                        ...
                        <div className="video-container">
                            <iframe
                                src="https://rutube.ru/play/embed/d1239d921facec4bd78fbe73c7413e09"
                                frameBorder="0"
                                allow="clipboard-write; autoplay"
                                webkitAllowFullScreen
                                mozallowfullscreen
                                allowFullScreen
                                title="Наш подход к ремонту домов"
                            />
                        </div>
                    </div>
                </section>
                ...
                {/* ---------------------------------------------------------------- */}
                {/*              ВНИМАТЕЛЬНЫ КО ВСЕМ ДЕТАЛЯМ (ВИДЕО)                */}
                {/* ---------------------------------------------------------------- */}
                <section className="details-attention-section">
                    <div className="container">
                        <h2 className="section-title">Внимательны ко всем деталям</h2>
                                ...
                                <div className="option-overlay">
                                    <div className="overlay-body">
                                        ...
                                        <ul className="option-features">
                                            <li>
                                                — В&nbsp;среднем через три месяца Вас ждёт новоселье — всё остальное мы&nbsp;берём на&nbsp;себя
                                            </li>
                        ...
                        <div className="design-order-grid">
                            ...
                            <div className="design-order-form-container">
                                ...
                                <ConsultationForm
                                    ...
                                    withNote={true}
                                    noteText="* для помещений более 300 кв. м."
                ...
                <div className="price-factors-section">
                    <div className="container">
                        ...
                        <div className="factors-grid">
                            ...
                            <div className="factor-item">
                                <div className="factor-icon">✓</div>
                                <p className="factor-text">Временные затраты, требуемые на&nbsp;ремонт загородных домов</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* ---------------------------------------------------------------- */}
                {/*                 ИНФОРМАЦИЯ О РЕМОНТЕ ДОМОВ                       */}
                {/* ---------------------------------------------------------------- */}
                <div className="renovation-info-section">
                    <div className="container">
                        <h2 className="section-title">Ремонт загородных домов «под ключ» в&nbsp;Москве и&nbsp;Московской области</h2>

                        <div className="info-text">
                            <p>
                                Наша компания предлагает услуги по&nbsp;расчету стоимости и&nbsp;проведению ремонта загородных домов.
                                Услуга «Ремонт дома под ключ» позволяет клиентам избавиться от&nbsp;множества проблем,
                            ...
                            <h3>Что в&nbsp;себя включает ремонт загородного дома «под ключ»?</h3>

                            <p>
                                Ремонт загородного дома «под ключ» включает в&nbsp;себя полный комплекс работ, который проводится
                            ...
                            <p>
                                Виды ремонтных работ зависят от&nbsp;дизайн-проекта и&nbsp;исходного состояния дома.
                                В&nbsp;новых загородных домах обычно требуется только финальная отделка без существенных изменений.
                                В&nbsp;старых постройках часто возникает необходимость в&nbsp;перепланировке, а&nbsp;иногда
                            ...
                            <h3>Какие бывают виды ремонта загородных домов</h3>

                            <p>
                                Ремонтные работы в&nbsp;загородном доме могут отличаться по&nbsp;объему и&nbsp;масштабу. Они делятся
                                на&nbsp;следующие виды:
                            </p>
                            ...
                            <p>
                                В&nbsp;новых домах обычно уже имеется черновой ремонт, проведена электропроводка и&nbsp;установлена
                            ...
                            <p>
                                Для успешного ремонта загородного дома «под ключ» важно обратиться к&nbsp;профессионалам, которые умеют
                            ...
                            <h3>Почему стоит заказать ремонт загородного дома «под ключ» в&nbsp;нашей компании?</h3>
                            ...
                            <p>
                                Заказать ремонт загородного дома «под ключ» на&nbsp;нашем сайте очень просто и&nbsp;выгодно. Выберите услугу,
                            ...
                            <p>
                                Мы&nbsp;рассмотрели основные аспекты, важные для тех, кто хочет заказать ремонт загородного дома «под ключ»:
        ...
        <ConsultationForm
          ...
          subtitle="Оставьте заявку — мы перезвоним в течение дня"
          buttonText="Отправить заявку"
          formType="Заказ ремонта"
        />
      </CallbackModal>
    ...
    export default RenovationHousePage;